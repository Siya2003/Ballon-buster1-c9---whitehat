...
for(var j=110;j<390;j=j+60){
  green_balloon = createSprite(100, j, 10, 10);
...
for(var r=130;r<350;r=r+60){  
  blue_balloon = createSprite(140, r, 10, 10);
  blue_balloon.addImage(blue_balloonImage);
  blue_balloon.scale=0.1;
}
  
  //create line of purple balloons using for loop
for(var l=180;l<250;l=l+60){
  pink_balloon = createSprite(180, l, 10, 10);
